...
import static no.kantega.polltibot.broker.Client.producerRecordCodec;
import static no.kantega.polltibot.broker.ClientSubscription.firehose;
import static no.kantega.polltibot.broker.ClientSubscription.subscription;
        ...
        return Eventually.callback(cb -> {
            executor.execute(() -> {
                ...
                PersistentQueue queue =
                        PersistentQueue.log("queue",executor);
